...
class _HomePageState extends State<HomePage>
  ...
  final List<String> _tabs = [
    'Trending', 'All', 'Latest', 'Teknologi', 'Science', 'Politik'
  ];
  ...
  final List<Map<String, dynamic>> _beritaList = List.generate(3, (index) => {
        ...
        actions: [
          IconButton( 
            icon : Container(
              ...
              child: const Icon(Icons.notifications_none, color: Color(0xFF1E73BE),),
            ),    
            onPressed: () {},
          )
        ],
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          if (index == 0) {
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Row(
                          ...
                          children: _carouselImages.asMap().entries.map((e) {
                            return Container(
                              width: 8.0,
                              height: 8.0,
            ...
            // 3. List berita
            final berita = _beritaList[index - 2]; // offset -2 karena TabBar & Carousel
            return Card(
